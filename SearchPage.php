...
<main>
      <div class="jumbotron">
        ...
        <?php
            ...
            $i=0;
            foreach ($terms as $each){ //continuously loop through our terms variable or our array and 
                                       //we want to grab each item in the array and each search term in the array will be name each
             $i++;
             if($i == 1){
                $query .="user_name  LIKE '%$each%'";

             }else{
                $query .=" OR user_name  LIKE '%$each%'";
             }
            }
