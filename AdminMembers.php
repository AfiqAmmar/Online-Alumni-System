         ...
         <!-- <form method= "POST" action="ProfileView.php">-->
          ...
          <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pb-3 mb-5 pt-3">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-2">
                ...
                <div class="col" >
                  <div class="card shadow h-100">    
                      ...
                      <div class="card-body text-dark">
                        ...
                        <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[0]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                      </div>
                  </div>
                </div>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<2) echo "hidden"; ?>>            
                  <img src=<?php echo "\"image/".$image[1]."\"" ?> class="card-img-top cropped">
                      ...
                      <div class="card-body text-dark">
                       ...
                       <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[1]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<3) echo "hidden"; ?>>
                  <img src=<?php echo "\"image/".$image[2]."\"" ?> class="card-img-top cropped">
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[2]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<4) echo "hidden"; ?>>            
                  <img src=<?php echo "\"image/".$image[3]."\"" ?> class="card-img-top cropped">
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[3]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<5) echo "hidden"; ?>>            
                  <img src=<?php echo "\"image/".$image[4]."\"" ?> class="card-img-top cropped">
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[4]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<6) echo "hidden"; ?>>            
                  <img src=<?php echo "\"image/".$image[5]."\"" ?> class="card-img-top cropped">
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[5]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<7) echo "hidden"; ?>>            
                  <img src=<?php echo "\"image/".$image[6]."\"" ?> class="card-img-top cropped">
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[6]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<8) echo "hidden"; ?> >            
                  <img src=<?php echo "\"image/".$image[7]."\"" ?> class="card-img-top cropped">
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[7]."\" class=\"btn-view btn position-absolute bottom-0 start-1\">View</a><br/>"; ?>
                ...
                <div class="col">
                  <div class="card shadow h-100" <?php if(count($id)<9) echo "hidden"; ?> >            
                  <img src=<?php echo "\"image/".$image[8]."\"" ?> class="card-img-top cropped" >
                         ...
                         <div class="card-body text-dark">
                           ...
                           <?php echo "<br/><a href=\"ProfileView.php?page=".$page."&id=".$id[8]."\" class=\"btn-view btn position-absolute bottom-0 start-1 \" >View</a><br/>"; ?>
